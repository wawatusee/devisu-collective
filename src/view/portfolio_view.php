 ...
 private $pathVideo='videos/';
    public function getView(array $catalogArray){
        ...
        foreach($catalogArray as $product){
            if($product->visible){
            $this->portfolioView.='<a href="#id01" class="video-link" onClick="play_this_video(\''.$this->pathVideo.$product->file.'\')">';
            ...
            $this->portfolioView.='<div class="thumb-video-arrow"><img src="img/deco/arrow-play-video.svg" alt="play-arrow-icon"></div>';
